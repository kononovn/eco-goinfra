...
const (
	...
	bpgAdvertisemenAPIGroup   = "metallb.io"
	bpgAdvertisemenAPIVersion = "v1beta1"
)
...
type BGPAdvertisementBuilder struct {
	Definition *types.BGPAdvertisement
	Object     *types.BGPAdvertisement
	...
	builder := BGPAdvertisementBuilder{
		...
		Definition: &types.BGPAdvertisement{
			TypeMeta: metaV1.TypeMeta{
				...
				APIVersion: fmt.Sprintf("%s/%s", bgpAPIGroup, bgpAPIVersion),
			},
			ObjectMeta: metaV1.ObjectMeta{
				Name:      name,
				Namespace: nsname,
			}, Spec: types.BGPAdvertisementSpec{},
		},
	}
...
func (builder *BGPAdvertisementBuilder) Get() (*types.BGPAdvertisement, error) {
...
func (builder *BGPAdvertisementBuilder) Create() (*BGPAdvertisementBuilder, error) {
	...
	if !builder.Exists() {
		...
		if err != nil {
			glog.V(100).Infof("Failed to covert structured BGPAdvertisement to Unstructured object")
...
func GetBGPAdvertisementGVR() schema.GroupVersionResource {
	return schema.GroupVersionResource{
		Group: bgpAPIGroup, Version: bgpAPIVersion, Resource: "bgpadvertisements",
	}
}
...
func (builder *BGPAdvertisementBuilder) convertToStructured(
	unsObject *unstructured.Unstructured) (*types.BGPAdvertisement, error) {
	bgpAdvertisement := &types.BGPAdvertisement{}
